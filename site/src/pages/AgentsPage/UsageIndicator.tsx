...
const getPeriodLabel = (period: ChatUsageLimitPeriod | undefined): string => {
	switch (period) {
		case "day":
			return "Daily";
		case "week":
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger asChild>
				<button
					type="button"
					className="ml-auto flex self-stretch flex-col justify-center items-start gap-1 border-none bg-transparent px-3 cursor-pointer select-none transition-colors text-content-secondary hover:bg-surface-tertiary/50 outline-none"
					style={{ fontSize: "13px" }}
				>
					<span className="shrink-0 whitespace-nowrap">
						{periodLabel} Usage
					</span>
					<div className="h-1.5 w-full overflow-hidden rounded-full bg-surface-tertiary shrink-0">
						<div
