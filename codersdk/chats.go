...
// DefaultChatWorkspaceTTL is the default time-to-live for chat
// workspaces when no value has been configured (1 hour).
const DefaultChatWorkspaceTTL = time.Hour
